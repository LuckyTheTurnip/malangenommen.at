document.addEventListener('DOMContentLoaded', () => {
	...
	const ORIENTATION_MOTION_X_DAMPING = 0.42
	const ORIENTATION_MOTION_Y_DAMPING = 0.4
	const ORIENTATION_TILT_X_DAMPING = 0.38
	const ORIENTATION_TILT_Y_DAMPING = 0.32
	const TILT_Z_DAMPING = 0.024
	const MOTION_DEADZONE = 0.7
	const TILT_DEADZONE = 0.6
	const MAX_MOTION_STEP_IDLE = 0.7
	const MAX_MOTION_STEP_ACTIVE = 1.34
	const MAX_TILT_STEP_IDLE = 0.56
	const MAX_TILT_STEP_ACTIVE = 1.16
	const MOTION_SMOOTHING_IDLE = 0.09
	const MOTION_SMOOTHING_ACTIVE = 0.3
